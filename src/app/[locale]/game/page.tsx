    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginTop: "20px" }}>
            ...
            <div style={{ position: "relative" }}>
                <div id="board"></div>
                <div id="game-over" style={{ display: "none", position: "absolute", inset: 0, background: "rgba(0,0,0,0.75)", flexDirection: "column", alignItems: "center", justifyContent: "center", borderRadius: "8px", gap: "16px" }}>
                    ...
                    <button onClick={() => requestRestart()} style={{ padding: "12px 28px", fontSize: "1.1rem", fontWeight: "bold", background: "#16a34a", color: "white", border: "none", borderRadius: "8px", cursor: "pointer" }}>Rejouer</button>
                </div>
            </div>
        </div>
    );
